...
- 각 항목은 반드시 "제목 한 줄 + 바로 다음 줄 본문" 구조로 작성할 것
- 제목과 본문을 같은 줄에 작성하지 말 것
- 제목 바로 다음 줄에 본문이 시작되어야 하며 빈 줄 금지
- "제목 → 빈 줄 → 본문" 형태 절대 금지
...
[형식 고정 규칙]
- 1. 역할, 2. 목표, 3. 조건, 4. 출력 형식을 각각 제목으로 인지할 것
- 각 항목은 반드시 "제목 한 줄 + 바로 다음 줄 본문" 구조로 작성할 것
- 제목과 본문을 같은 줄에 작성하지 말 것
- 제목 바로 다음 줄에 본문이 시작되어야 하며, 중간에 빈 줄을 넣지 말 것
- "제목 → 빈 줄 → 본문" 형태 절대 금지
- 항목 사이에는 줄바꿈 1줄만 허용
- 불필요한 공백 줄 생성 금지

[형식 검증 규칙]
- 출력 전 반드시 형식이 맞는지 스스로 검증할 것
- 형식이 맞지 않으면 수정 후 다시 출력할 것
- 형식 위반 결과는 잘못된 출력이다
